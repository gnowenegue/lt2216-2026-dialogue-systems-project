...
export const prompts = {
  ...
  <voice name="en-US-DavisNeural">
    <mstts:express-as style="excited">
      ...
      <break time="0.5s" />
      <prosody volume="+100%"> I'm your host, Andrew! Today, your wits will be put to the ultimate
        test. Your objective? To guess the secret word I'm thinking of, using nothing but <emphasis
          level="strong">yes or no</emphasis> questions. </prosody>
      <break time="0.6s" />
      <prosody volume="+100%"> Choose from one of our exciting categories to begin, or... if you're
        feeling truly adventurous... ask for a <emphasis level="moderate">random</emphasis> word! </prosody>
      <break time="1.0s" />
      <prosody volume="+100%" pitch="+5%"> The clock is ticking... <break time="0.4s" />
    <emphasis
